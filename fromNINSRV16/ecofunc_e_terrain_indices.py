...
def main():
    ...
    for size in neighbourhoods:
        ...
        for dem_tile in maps:
            ...
            stats = grass.parse_command('r.stats', flags='c', input=dem_tile)
            ...
            if len(stats.keys()) > 1:
                ...
                print 'tile {} contains open land, file {} created'.format(dem_tile, r_height_avg)
                ...
                print 'tile {} contains nothing'.format(dem_tile)
