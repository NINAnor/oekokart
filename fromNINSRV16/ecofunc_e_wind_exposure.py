...
def main():
    ...
    r_topex_exposure = 'dem_10m_topex_exposure'
    grass.run_command('r.mapcalc', overwrite=True,
                      expression='{-({} < 0) * {} - ({} < 0) * {} - \
                                    ...
                                    ({} < 0) * {} - ({} < 0) * {}'.format(\
                                    r_topex_exposure,\
                                    dem_10m_topex_N,dem_10m_topex_N,\
                                    dem_10m_topex_NE,dem_10m_topex_NE,\
                                    dem_10m_topex_E,dem_10m_topex_E,\
                                    dem_10m_topex_SE,dem_10m_topex_SE,\
                                    dem_10m_topex_S,dem_10m_topex_S ,\
                                    dem_10m_topex_SW,dem_10m_topex_SW,\
                                    dem_10m_topex_W,dem_10m_topex_W,\
                                    dem_10m_topex_NW,dem_10m_topex_NW))
